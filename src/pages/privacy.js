...
const Privacy = ({location}) => (
  <Layout location={location}>
    <SEO title="Privacy" />
    <h1>Privacy</h1>
    Privacy Policy Last updated: December 15, 2021 This Privacy Policy describes
    ...
    and how the law protects You. We use Your Personal data to provide and
    improve the Service. By using the Service, You agree to the collection and
    use of information in accordance with this Privacy Policy. This Privacy
    Policy has been created with the help of the Privacy Policy Generator.
    Interpretation and Definitions Interpretation The words of which the initial
    letter is capitalized have meanings defined under the following conditions.
    ...
    Privacy Policy: Account means a unique account created for You to access our
    Service or parts of our Service. Affiliate means an entity that controls, is
    ...
    You on any electronic device, named WorkoholicsStore Company (referred to as
    either "the Company", "We", "Us" or "Our" in this Agreement) refers to
    Workoholics, Pl. San Vicente 2, piso 1°. 48001, Bilbao (Bizkaia). Inscrita
    en el Registro de VIZCAYA,. Cookies are small files that are placed on Your
    ...
    Country refers to: Spain Device means any device that can access the Service
    such as a computer, a cellphone or a digital tablet. Personal Data is any
    information that relates to an identified or identifiable individual.
    Service refers to the Application or the Website or both. Service Provider
    ...
    in analyzing how the Service is used. Usage Data refers to data collected
    ...
    Website refers to Workoholics, accessible from workoholics You means the
    ...
    but is not limited to: Email address Usage Data Usage Data Usage Data is
    ...
    certain section and verifying system and server integrity). Cookies can be
    ...
    cookies: Cookies by PrivacyPolicies Generator. We use both Session and
    Persistent Cookies for the purposes set out below: Necessary / Essential
    Cookies Type: Session Cookies Administered by: Us Purpose: These Cookies are
    ...
    provide You with those services. Cookies Policy / Notice Acceptance Cookies
    ...
    Cookies Type: Persistent Cookies Administered by: Us Purpose: These Cookies
    ...
    having to re-enter your preferences every time You use the Website. For more
    ...
    Policy. Use of Your Personal Data The Company may use Personal Data for the
    following purposes: To provide and maintain our Service, including to
    monitor the usage of our Service. To manage Your Account: to manage Your
    ...
    available to You as a registered user. For the performance of a contract:
    ...
    Us through the Service. To contact You: To contact You by email, telephone
    ...
    You have opted not to receive such information. To manage Your requests: To
    attend and manage Your requests to Us. For business transfers: We may use
    ...
    by Us about our Service users is among the assets transferred. For other
    ...
    with Us. With business partners: We may share Your information with Our
    ...
    users and may be publicly distributed outside. With Your consent: We may
    ...
    when they are posted on this page. Contact Us If you have any questions
    about this Privacy Policy, You can contact us: By email:
    workoholicsstoreexample@mail.com
  </Layout>
)
